...
from core.filters import filter_products, sort_products, get_cheapest_price, parse_price
...
async def search_get(
    ...
    category: Optional[str] = Query(None, description="Filter stores by category"),
):
...
async def _do_search(
    ...
    # Batch fetch to avoid overwhelming
    all_results = []
